...
%
% TODO: tweak (or not) your model to get more than 96% 'test' accuracy  [10 points]  
%
...
% save your model for bonus 10 points if the model gets more than 98% accuracy.
if acc_test > 0.98
   fprintf('GREAT! You got the bonus point!, Dont forget to save your model! :) \n')
   save('bonusModel')  
end
